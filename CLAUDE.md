...
3. **Baseline selection:** prefer 14-day primary, fall back to 7-day. 30-day is *stable context only*, never the active comparator.
4. **Sleep quality score weights:** 30% duration, 20% efficiency, 25% deep, 25% REM. Unspecified-stage nights use 60/40 duration/efficiency and set `isPartial`.
